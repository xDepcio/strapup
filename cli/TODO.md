...
[TODO] #9 
    Testy jednostkowe - w constructTemplates.test.ts wkleiłem prywatną funkcję bo nie wiem jak zaimportować
    Headless.test.ts - test jest pending zamiast passed, trzeba poprawić
