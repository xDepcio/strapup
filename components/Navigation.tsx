...
export default function Navigation() {
    ...
    return (
        <nav id="main-nav" className="w-full flex items-center justify-center sticky transition-all py-4 border-b-[1px] top-0 z-10 shadow-sm backdrop-blur-[8px]  bg-white/70">
